...
urlpatterns = [
    ...
    path(
        ...
        views.update_lab_test
    ),

    path(
        'labtests/<int:labTestId>/details',
        views.get_lab_test
    ),

    path(
        'labtests/list',
        views.list_lab_tests
    ),
    ...
    path(
        ...
        views.record_lab_test_result
    ),

    path(
        'labtests/results/appointment/<int:appointmentId>',
        views.get_lab_test_result_by_appointment
    ),

    path(
        'labtests/results',
        views.list_lab_test_results
    ),

    path(
        'labtests/<int:labTestPrescriptionId>/deactivate',
